...
Note: ROS2 Nodes are prone to crashes. Rebuild and source to launch the nodes again if errors arise.
Additionally, consider removing directories "install", "build" and "log". Then rebuild the package.
